...
//		String sql =  "select * from emp"; // -> ; 안들어감!
		...
		String sql =   // " " 에 blank 넣어야함!
				"select e.ename as \"사원명\", e.sal as \"사원급여\", m.ename as \"상사명\", m.sal as \"상사급여\"" +   //alias & escape처리 
				"from emp e " + 
			    "join emp m " +
			     "on e.mgr = m.empno " +
			"where e.sal > m.sal";
		...
		//1. JDBC Driver 설치 : OJDBC6.jar file을 class path에 추가해서 인식시키기 -> C:\lib\OJDBC6.jar 여기 있다~
