...
datafile 'c:\lib\demo.sql'
size 30M
autoextend on next 2M maxsize UNLIMITTED;

--복습
datafile 'D:\Dropbox\응용SW엔지니어링양성과정\lib\demo.sql'
size 30M
autoextend on next 2M maxsize UNLIMITTED;
...
col tname for a14;
col tabtype for a14;
col clusterid for a14;

col bookid for 9999;
col bookname for a20;
col price for 99999;
col publisher for a14;
