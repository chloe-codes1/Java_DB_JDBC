...
//		ImageIcon icon = new ImageIcon("e://work//workspace_0708//java_02_ex//src//day22_ex/chubbyCat.jpg");
		ImageIcon icon = new ImageIcon("d:\\Dropbox\\응용SW엔지니어링양성과정\\Eclipse\\work\\workspace_0708\\java_02_ex\\src\\day22_ex/chubbyCat.jpg");
...
//		pack();
		...
		add.addActionListener(e -> {
			...
			boolean b = mgr.addBook(new Book(title.getText(), p));
			if (b) {
		...
		search.addActionListener(e -> {
			...
			try {
				output.setText("");
				output.append(" [ " + title.getText() + " 도서를 검색합니다. ] \n");
				output.append("검색 결과: \n");
		...
		// [ SAVE Button ]
		// -> autosaving 가능하게 만들어서 save button을 사용할 필요 없어졌기 때문에 주석 처리함!
//		save.addActionListener(e -> {
//
////			mgr.saveBook();
//
////			file.save(mgr,"c:\\lib\\BookApp_ver2.txt");
//			mgr.save();
...
//		});
		...
		// [ LOAD Button ]
		// -> load button을 사용할 필요 없어져서 주석 처리함!
