...
public class BookTest_equals {
	...
	public static void main(String[] args) {
		...
		System.out.println(b1.equals(b2)); //true -?override 했더니 true로 제대로 출력됨
		
		System.out.println(b1.equals(null)); //false -> equals(Object obj)의 obj==null;에 걸려서!
		System.out.println(b1.equals(msg1)); //false -> msg1의 class가 Book이 아니라 String이라서 걸림!
		
		//다 쓴 자원을 null assign을 해야 Garbage Collection의 대상이 된다
		//-> null assign을 꼭 해줘야 memory 누수 막을 수 있음!!!! 
			//-> 다 쓴 자원 null assign 하는건 기본임! 기억해!
//		b1 = null;
//		b2 = null;
